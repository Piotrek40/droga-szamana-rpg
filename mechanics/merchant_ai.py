...
class MerchantAI:
    ...
    def __init__(self, merchant_id: str, name: str, personality: str = "neutral"):
    ...
    def calculate_selling_price(self, item_id: str, base_cost: float, 
        ...
        # Finalna cena
        final_price = (base_price * mood_modifier * reputation_modifier * 
    ...
    def calculate_buying_price(self, item_id: str, item_value: float, 
        ...
        # Finalna cena
        final_price = (item_value * base_buy_ratio * mood_modifier * 
