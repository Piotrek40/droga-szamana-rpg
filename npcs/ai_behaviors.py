...
def has_escape_plan(npc: Any, context: Dict) -> bool:
    ...
    for goal in npc.goals:
        if "escape" in goal.name.lower() and goal.active:
...
def seek_medical_attention(npc: Any, context: Dict) -> NodeStatus:
    ...
    npc.add_memory(
        ...
        location="infirmary",
        importance=0.8,
        emotional_impact={"fear": 0.6, "pain": 0.7}
    )
...
def collapse_from_exhaustion(npc: Any, context: Dict) -> NodeStatus:
    ...
    npc.add_memory(
        ...
        location=npc.location,
        importance=0.7,
        emotional_impact={"fear": 0.4, "exhaustion": 0.9}
    )
...
def engage_in_group_activity(npc: Any, context: Dict) -> NodeStatus:
    ...
    if participants:
        ...
        npc.add_memory(
            ...
            location=npc.location,
            importance=0.3,
            emotional_impact={"happy": 0.4, "social": 0.5}
        )
